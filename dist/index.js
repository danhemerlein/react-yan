...
`,v=a.default.div`
  ...
  ${({width:e})=>e&&`width: ${e}`};
`,A=({color:t="inherit",textDecoration:r="underline",textDecorationHover:o="underline"}={})=>e.css`
    ${r&&t&&o&&`\n      color: ${t};\n      text-decoration-color: ${t};\n      text-decoration: ${r};\n\n      &:visited {\n        text-decoration: ${r};\n        color: ${t};\n      }\n\n      &:active {\n        text-decoration: ${r};\n        color: ${t};\n      }\n\n      &:hover {\n        text-decoration: ${o};\n        color: ${t};\n      }\n    `};
  `,F=(e,t,r="inherit",o="left")=>e&&r&&o&&`\n      text-align: ${o};\n      color: ${r};\n      font-family: ${h("fontFamily",e)};\n      font-size: ${h(t,e)};\n    `,b=a.default.h1`
